...
export default function HelpPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:codewithevilxd@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <h1 className="text-3xl font-bold mb-6 text-center text-gray-900 dark:text-white">Help & Support</h1>

      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <p className="text-gray-600 dark:text-gray-300 mb-6 text-center">
          Need help? Send us your query and we will get back to you.
        </p>
